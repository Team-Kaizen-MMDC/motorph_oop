 ...
 */
public class ITAdmin extends Employee implements ITAdministrator {
    ...
    public ITAdmin(int employeeId, String firstName, String lastName,
            String birthday,
        ...
        super(employeeId, firstName, lastName, birthday, address, phoneNumber,
                employmentStatus, jobPosition, supervisorId,
                role, basicSalary, riceSubsidy, phoneAllowance,
                clothingAllowance,
                grossSemiMonthlyRate, hourlyRate, sssNumber, philhealthNumber,
                tinNumber, pagibigNumber);

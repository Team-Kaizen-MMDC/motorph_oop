...
public class HRDashboard extends JFrame {
    ...
    private void initComponents() {
        ...
        jPanel_EmpDashboard.setBorder(javax.swing.BorderFactory.createTitledBorder("HR Dashboard"));
        jPanel_EmpDashboard.setName("HR Dashboard"); // NOI18N
        ...
        btn_employee_database.setText("Employee Database");
        btn_employee_database.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_employee_databaseActionPerformed(evt);
            }
        });
    ...
    private void btn_employee_databaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_employee_databaseActionPerformed
        Employee_Database employee_databaseDashboard = new Employee_Database();
